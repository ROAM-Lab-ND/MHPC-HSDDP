function [ power_in, power_diss, energy ] = get_motor_performance( time, torque, speed )
...
power_in = interp2(s_grid, t_grid, pe_grid, speed, torque, 'spline');
power_diss = interp2(s_grid, t_grid, loss_grid, speed, torque, 'spline');
