classdef mhpcControllerNew < RobotController
    properties
    ...
    methods % constructor
        function C = mhpcControllerNew(WBModel, FBModel, gait, Problem_data)
            if nargin > 0
                initialization(C, WBModel, FBModel, gait, Problem_data);
            end
        end
                      
        function initialization(C,WBModel, FBModel, gait, Problem_data)
            C.WBModel = WBModel;
            C.FBModel = FBModel;
            C.gait = gait;                       
